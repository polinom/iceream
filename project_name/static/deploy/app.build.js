...
// Change this before you compile you project for production server,
// beacuse you static url most of all will be different
var prod_stat_url = '/static/js/';

// Loads the Require.js Optimizer
var requirejs = require('../js/libs/r.js');
...
var configs = [
    {
        ...
        mainConfigFile: "../js/app/config/MobileInit.js",
    ...
    },
    {
        ...
        include: [prod_stat_url+"app/config/DesktopInit", prod_stat_url+"app/controllers/DesktopController"],
        // The optimized desktop build file will put within the app directory
        out: "../js/app/config/DesktopInit.min.js"
    }
];
